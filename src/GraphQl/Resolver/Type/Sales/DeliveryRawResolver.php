...
class DeliveryRawResolver implements ResolverInterface, AliasedInterface, DeliveryRawResolverInterface
{
    ...
    public function fetchDelivery(int $clientId, int $deliveryId): array
    {
        ...
        return $this->deliveryRepository->getDeliveryRaw($deliveryRequest);
    }
